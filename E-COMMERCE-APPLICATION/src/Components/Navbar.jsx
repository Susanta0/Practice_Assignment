    ...
    <nav className="flex justify-between bg-gray-900 text-white">
      <div className="px-5 xl:px-8 py-3 flex w-full items-center">
        <a className="text-3xl font-bold font-heading" href="#">
         <img className="h-12 w-20 rounded-full " src="https://i.pinimg.com/564x/3d/59/d8/3d59d8f82ca91378d6108c5fa33805f4.jpg" alt="logo"/>
         
        </a>
        
        <ul className="hidden text-2xl md:flex px-4 mx-auto font-semibold font-heading space-x-60">
